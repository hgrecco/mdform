...
from typing import Dict, AnyStr, Optional, Any, Match, Pattern, Tuple, NewType
...
class Field(_RegexField):
    ...
    def match(cls, line: str) -> Optional[Tuple[str, FieldDict]]:
        ...
        for ft in cls.FIELD_TYPES:
            ...
            return label, FieldDict(dict(type=ft.__name__, required=required, **matched))
