...
<p>{{ form_field(form.name, form_type='horizontal', class="form-control", maxlength=30) }}
{{ form_field(form.e_mail, form_type='horizontal', class="form-control") }}
{{ form_field(form.really_annoying_323_name, form_type='horizontal', class="form-control") }}</p>
<p>{{ form_field(form.user_name, form_type='horizontal', class="form-control") }}</p>"""
...
def test_wtf():
    md = Markdown(extensions=[FormExtension(fmt="jinja2-wtf-bs4")])
